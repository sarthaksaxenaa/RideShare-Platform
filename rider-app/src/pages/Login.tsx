      ...
      <div className={styles.card}>
        ...
        <div className={styles.branding}>
          <div className={styles.logo}>
            <div className={`${styles.logoIconWrap} ${isDriver ? styles.logoIconWrapDriver : ''}`}>
              <svg className={styles.logoSvg} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
          ...
          <p className={styles.subtitle}>{isDriver ? 'Drive & Earn' : 'Your ride, your way'}</p>
        </div>
        ...
        <div className={styles.roleSelector}>
          ...
          >
            <svg className={styles.roleSvg} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
